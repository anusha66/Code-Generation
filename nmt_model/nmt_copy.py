...
class NMT(nn.Module):
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2, input_feed=True, label_smoothing=0., lm=False, copy=False):
...
#         pdb.set_trace()
    ...
    def step(self, x: torch.Tensor,
        ...
        return (h_t, cell_t), att_t, ctx_t, alpha_t
    ...
    def dot_prod_attention(self, h_t: torch.Tensor, src_encoding: torch.Tensor, src_encoding_att_linear: torch.Tensor,
        ...
        ctx_vec = torch.bmm(softmaxed_att_weight.view(*att_view), src_encoding_att_linear).squeeze(1)
