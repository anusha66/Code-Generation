...
Options:
    ...
    --input-feed                            use input feeding [default: 1.0]
...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2, input_feed=1.0, label_smoothing=0.):
        ...
        decoder_lstm_input = embed_size + hidden_size*2 if self.input_feed else embed_size
    ...
    def decode(self, src_encodings: torch.Tensor, src_sent_masks: torch.Tensor,
        ...
        att_tm1 = torch.zeros(batch_size, self.hidden_size*2, device=self.device)
    ...
    def beam_search(self, src_sent: List[str], beam_size: int=5, max_decoding_time_step: int=70) -> List[Hypothesis]:
        ...
        h_tm1 = dec_init_vec
        att_tm1 = torch.zeros(1, self.hidden_size*2, device=self.device)
